...
<template>
    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8 text-center">
            <h1 class="font-semibold text-xl p-6 text-gray-900 dark:text-gray-100">Solutech Code Challenge</h1>
            <h2 class="font-semibold text-xl p-6 text-gray-900 dark:text-gray-100">Task Tracker</h2>
